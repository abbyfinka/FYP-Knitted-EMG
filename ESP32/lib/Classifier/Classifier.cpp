...
{
    float iemg[8] = {0.0}, msv[8] = {0.0}, var[8] = {0.0}, rms[8] = {0.0}, ln_rms[8] = {0.0}, kurt[8] = {0.0}, skew[8] = {0.0};
    ...
    {
        features[c * 7] = iemg[c];
        features[c * 7 + 1] = msv[c] / WINDOW_SIZE;
        features[c * 7 + 2] = var[c] / (WINDOW_SIZE-1);
        features[c * 7 + 3] = sqrt(rms[c] / WINDOW_SIZE);
